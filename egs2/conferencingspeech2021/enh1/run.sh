...
./enh.sh \
    ...
    --enh_args "--rir_scp dump/raw/${train_set}/rirs.scp --rir_max_channel 8 --rir_apply_prob 1.0 --noise_scp dump/raw/${train_set}/noises.scp --noise_max_channel 1 --noise_apply_prob 1.0 --noise_db_range 0_30" \
